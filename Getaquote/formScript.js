...
// form Script
function openNav() {
    document.getElementById("block2").innerHTML = "Bedroom"+num;
    if(num2 > 0){
        var createP = document.createElement("p");
        var textNode = document.createTextNode("other" +num2);
        createP.appendChild(textNode);
        document.getElementById("block2").appendChild(createP);
    }
    ...
    // document.getElementsByClassName("body_card").style.filter = "blur(8px)";
}
